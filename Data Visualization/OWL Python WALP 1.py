...
# Modified from other Python examples files, I wanted to be
# able to duplicate some of the curriculum offered in
# Microworlds. It won't have some of the fancy controls like 
# sliders or, maybe even, buttons. But, we should be able
# to get some of the spirit of the assgnments.
# For this reason I've decided that no external library will
# forbidden as long as we get the functionality needed.
# This is only the beginning...

# The goal in this program is to get a basic graphics
# window going. 

#Documentation.
# I don't know if this is the right "Processing" but
# https://py.processing.org/tutorials/p3d/
# Tutorial (20 min) on Push/PopMatrix()
